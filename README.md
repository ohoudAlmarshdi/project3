...
- Materials must be submitted by 09:00 a.m. Sunday, 16 September AST.

We would like to be able to pull everyone's projects into the [master repository](https://git.generalassemb.ly/DSI-MiSK-1/project-3) so everyone can view what anyone else in our cohort did.  In order to do this, you will need to put all of your project specific materials in their own folder within your repository (Everything thats not the `.gitignore` and `Readme.md`).  The labeling convention for this folder should be `first-last`.
...
1. We'll be acquiring our a from live web data: [Reddit.com](https://www.reddit.com/)
